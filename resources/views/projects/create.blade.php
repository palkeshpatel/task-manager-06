...
@section('content')
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="mt-4 text-3xl font-bold text-gray-900">Create New Project</h1>
            <p class="mt-2 text-gray-600">Add a new project to organize your tasks and track progress.</p>
        </div>
